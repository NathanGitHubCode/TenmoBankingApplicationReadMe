...
I've worked with a partner to create a Venmo-like banking application and Restful API using the Java and PostgreSQL language. This project utilizes the Spring Boot framework, OOP principles, JSON web tokens (JWT), DAO and model-view-controller (MVC) design patterns.
